  ...
  return (
    <section className="py-[10rem] lg:py-[12rem] px-[1.2rem] md:px-[5rem] lg:px-[7rem] ">
      ...
      <p className="mt-[2rem] lg:text-[1.1rem]">
        This Privacy Policy describes the policies of Based Solar, Bulgaria,
        Sofia, Sofia 1000, Bulgaria, email: contact@basedsolar.com, phone: +359
        877118393 on the collection, use and disclosure of your information that
        we collect when you use our website ( https://basedsolar.com ). (the
      ...
      <ol className="privacy-policy-ol">
        ...
        <li>
          ...
          <p className="mt-[0.5rem] lg:text-[1.1rem]">
            ...
            contact@basedsolar.com. We will respond to your request in
        ...
        <li>
          ...
          <p className="mt-[0.5rem] lg:text-[1.1rem]">
            ...
            Officer at Based Solar, Bulgaria, Sofia, email:
            contact@basedsolar.com. We will address your concerns in accordance
            with applicable law.
          </p>
        </li>
      </ol>
